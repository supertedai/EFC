"""FALSIFISERBARHET: alle 113 noder skal ha en eksplisitt avgjoerelse.
...
def test_alle_noder_har_falsifiserbarhetsavgjoerelse(noder: list[dict]) -> None:
    """Avgjorelser skal dekke 113 av 113 noder, ikke bare feltkapasiteten."""
    avgjort = [
        n for n in noder
    ...
    assert len(avgjort) == len(noder) == 113, (
