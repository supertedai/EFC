...
`ikke_falsifiserbar_grunn` (kort t_c11ffa45): denne filen sier hvilke
prefikser som ikke er vaare paastander, den maaler ikke at noen har svart.
Dekningen — 113 av 113 — maales i `test_atlas_avgjorelse.py`.
