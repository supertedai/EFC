...
| **Papers** | 157 papers in [`/docs/papers/efc/`](./docs/papers/efc/) |
...
> See [`/docs/papers/efc/`](./docs/papers/efc/) for the complete collection of 157 papers, all with AI-friendly packages (100% coverage). Eight hand-curated 10/10 validation reports with full reproducible pipelines.

---

## AI-Friendly Paper Packages

All 157 papers have AI-friendly packages (100% coverage as of April 2026). Eight hand-curated 10/10 validation reports with full reproducible pipelines:
...
├── docs/
│   ├── papers/efc/     # 157 papers with AI-friendly packages (100%)
