...
The [Validation Ledger](./docs/public/EFC_Validation_Ledger.html) (v3.17 / v4.8 internal) tracks 132 public tests. Overall stage: **Non-rejectable model** (global verdict OPEN).
