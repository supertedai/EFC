...
├── EFC_H4-MIN-01_fire_frys_beslutningsnotat_2026-09-18.md  # De fire frysene for H4-MIN-01, til menneskeord
...
├── proposals/                    # forslag til atlas-/skjemaendringer, som patcher (ikke anvendt)
└── README.md                     # This file
```
