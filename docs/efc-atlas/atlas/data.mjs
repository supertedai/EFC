...
export const NODES = [
  ...
  },
  {
    ...
    "kind": "box",
    "ghost": true,
    "one": "Perspective: paradigm. SOC og SOH",
    "what": "spennings-, str\u00f8m- og temperatursensorer \u2014 proxy chain: coulomb-telling (I over tid) -> SOC-estimat -> V (OCV) -> SOC-korreksjon kun etter hvile -",
    "how": "Buffer role: cellekjemien er mikro-bufferen: interkalasjonsstrukturen holder og slipper litiu. Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
  ...
  },
  {
    ...
    "kind": "box",
    "ghost": true,
    "one": "Perspective: paradigm. ladekurven V(t), I(t)",
    "what": "V/I-sensorer i laderen \u2014 proxy chain: V, I over tid -> ladekurven -> str\u00f8mavtag under CV under str\u00f8mterskel -> ladeslutt-KRITERI",
    "how": "Buffer role: laderen er bufferens fyllemekanisme: den styrer hvor fort energien str\u00f8mmer inn. Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
  ...
  },
  {
    ...
    "kind": "box",
    "ghost": true,
    "one": "Perspective: paradigm. SOC, effektbalanse, sykluser",
    "what": "Battery Monitor (LiFePO4-BMS), VE.Bus (inverter/lader), Grid meter, PV-vekselretter \u2014 proxy chain: shunt (A) -> coulomb-telling -> SOC -> spenningsmaaling (V) -> terminaltilstand -> lastm\u00e5l",
    "how": "Buffer role: batteriet ER en buffer i bred forstand: homeostase (holder nettspenningen stabil. Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
  ...
  },
  {
    ...
    "kind": "box",
    "ghost": true,
    "one": "Perspective: paradigm. utgangsspenning, frekvens, effekt",
    "what": "V/I/f-sensorer paa utgangen \u2014 proxy chain: DC-effekt inn -> AC-effekt ut (virkningsgrad) -> utgangsspenning/frekvens -> nettkvalitet",
    "how": "Buffer role: inverteren har en liten intern buffer (DC-link-kondensatorer) som glatter pulsbr. Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
  ...
  {
    "id": "efc-victron-cccv-engine",
    "code": "VC",
    "name": "efc.victron_cccv_engine",
    "short": "victron cccv e",
    "group": "struktur",
    "gx": 8.7,
    "gy": 14.600000000000001,
    "w": 2,
    ...
    "ghost": false,
    "one": "Perspective: paradigm. ladekurven V(t), I(t)",
    "what": "V/I-tidsserie \u2014 motoren leser aldri live-data selv \u2014 proxy chain: V(t), I(t) -> regime-labels (0=CC, 1=CV) -> foerste CV-label -> kneet (t_k, V_k, I_k)",
    "how": "Buffer role: batteriets elektrokjemi er bufferen som gj\u00f8r overgangen mulig \u2014 CV-fasen tolkes . Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
  ...
  },
  {
    ...
    "kind": "box",
    "ghost": true,
    "one": "Perspective: paradigm. atlaset selv",
    "what": "lesningens ramme \u2014 proxy chain: atlas-tekst -> lesning -> forst\u00e5else",
    "how": "Buffer role: atlaset er bufferen som holder det kjente f\u00f8r det neste legges til. Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
  ...
  },
  {
    ...
    "kind": "box",
    "ghost": true,
    "one": "Perspective: paradigm. skjemaet selv",
    "what": "definisjonens ramme \u2014 proxy chain: feltnavn -> betydning -> verden",
    "how": "Buffer role: skjemaet er bufferen som holder formen stabil mellom revisjoner. Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
  ...
  {
    "id": "efc-selv-paradigme-tid",
    "code": "PT",
    "name": "efc.selv.paradigme_tid",
    "short": "paradigme tid",
    "group": "epist",
    "gx": 6.3,
    "gy": 25.0,
    ...
    "kind": "box",
    "ghost": false,
    "one": "Perspective: paradigm. tidskoordinatet",
    "what": "SI-sekundet (cesium-klokken) \u2014 proxy chain: svingning -> sekund -> tid",
    "how": "Buffer role: tidskoordinatet er bufferen som holder hendelser i rekkef\u00f8lge. Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
  ...
  {
    "id": "efc-selv-paradigme-masse",
    "code": "EF",
    "name": "efc.selv.paradigme_masse",
    "short": "paradigme mass",
    "group": "ghost",
    "gx": 8.7,
    "gy": 25.0,
    "w": 2,
    ...
    "kind": "box",
    "ghost": true,
    "one": "Perspective: paradigm. massebegrepet",
    "what": "SI-kilogrammet \u2014 proxy chain: kraft/akselerasjon -> kg -> masse",
    "how": "Buffer role: massebegrepet er bufferen som holder tregeheten tellelig. Epistemic: hypotese / proxy / minoritet.",
    "steps": [
      [
        "Perspective",
        "paradigm"
...
export const CH = [
  ...
  },
  {
    ...
    "title": "Structures \u2014 H2O and chemistry",
    "reveal": [
      "efc-victron-cccv-engine",
      "kjemi-periodesystemet"
    ],
    "lede": "Chapter 5 of 9 \u2014 a few structures at a time.",
    "story": "<p>Revealed: efc-victron-cccv-engine, kjemi-periodesystemet.</p>",
    "flow": null
  },
  {
    "id": "ch6",
  ...
  },
  {
    ...
    "title": "Epistemics",
    "reveal": [
      "efc-selv-paradigme-tid"
    ],
    "lede": "Chapter 7 of 9 \u2014 a few structures at a time.",
    "story": "<p>Revealed: efc-selv-paradigme-tid.</p>",
    "flow": null
  },
  {
    "id": "ch8",
    ...
    "story": "<p>Revealed: batteri-buffer, batteri-celle, batteri-inverter, batteri-lading, efc-cluster-engine, efc-enerflyt-engine, efc-growth-engine, efc-hubble-engine, efc-jordskjelv-engine, efc-klima-engine, efc-l1, efc-l2, efc-l3, efc-lensing-engine, efc-mu-kz-engine, efc-oekonomi-engine, efc-orbital-engine, efc-romvaer-engine, efc-rotation-engine, efc-samfunn-engine, efc-selv-atlas, efc-selv-paradigme-masse, efc-selv-skjema, efc-solar-flare-engine, efc-tidevann-engine, efc-transient-engine, efc-water-phase-engine, h2o-droplet, h2o-gas, h2o-liquid, h2o-solid, h2o-supercritical, h2o-triple-point, homo-aksjonspotensial, homo-cellesyklus, homo-evolusjon, homo-feber-regime, homo-fluxus, homo-genregulering, homo-hjerte-syklus, homo-homeostase-buffer, homo-immunologi, homo-metabolisme, homo-okologi, homo-sovn-vaaken, lys-sol, obs-bao, obs-bbn, obs-bullet, obs-cc, obs-cluster-hmf, obs-cluster-mass, obs-cmb-lensing, obs-cmb-tt, obs-eg, obs-fsigma8, obs-gw-ct, obs-h0-tension, obs-isw, obs-jwst-ems, obs-ksz, obs-pta-gwb, obs-rar, obs-s8, obs-satellites, obs-w0wa, optikk-dispersjon, regnbue, regnbue-observator.</p>",
    "flow": null
  },
  {
    "id": "all",
    ...
    "reveal": [],
    "lede": "Everything at once \u2014 82 nodes, 79 relations.",
