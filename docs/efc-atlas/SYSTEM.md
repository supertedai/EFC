...
**In one line.** Perspective: consensus. astronomical observations and catalogued sources
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — MAST/CAOM carries the measurement practice and the stream makes it available; this is a social channel, not the truth it

#### RK · kosmos.romvaer_swpc

**In one line.** Perspective: consensus. Kp state and storm level
...
**In one line.** Perspective: consensus. GOES X-ray flux and flare class
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — NOAA's GOES instrumentation and solar physics' alerting community carry the X-ray measurement; the observation is a deli
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — The DESI collaboration and the BAO practice are the expected social channel; the absence of a stream is reported explici
...
**In one line.** Perspective: consensus. climate and development indicators per country and year
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — World Bank carries the climate's institutional measurement practice; the stream makes the country and year indicators av
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — MGnify carries the measurement practice and the stream makes it available; this is a social channel, not the truth itsel
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — GDELT carries the environment's news measurement practice; the stream makes coded coverage available, but this is not th
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — World Bank carries the economy's institutional measurement practice; the stream makes the country and year indicators av
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — IMF DataMapper carries the measurement practice and the stream makes it available; this is a social channel, not the tru
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — GDELT carries the economy's news measurement practice; the stream makes coded coverage available, but this is not the tr
...
1. **Perspective** — consensus
2. **Epistemics** — stottet / direkte / institusjonell
3. **Social mechanism** — Glaciology's field and remote-sensing community is the expected channel; the glacier observation does not exist on the b
