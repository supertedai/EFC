...
- **L0 · efc.l0** — initial conditions and structure seeds
  perspective=paradigm · engine=not specified · bus=no bus route — the subject does not… · S-axis=regime S->0 · clarity C(S) at S->0: undifferentiated clarity… · questions=1 · group=yes

## The grid
- **GH · efc.grid_higgs** — The Grid-Higgs framework: entropic and structural theory of gravity…
  perspective=paradigm · engine=not specified · bus=no bus route — the subject does not… · S-axis=not measured · questions=1 · group=yes
...
- **GM · efc.grid_mikrofysikk** — From grid microphysics to the radial acceleration relation — minimal…
  perspective=paradigm · engine=not specified · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **GE · efc.grid_mikro_engine** — Gamma(rho) and Deff(rho)
  perspective=paradigm · engine=grid_mikro · bus=not specified · S-axis=not measured · questions=0 · group=yes
...
- **RO · efc.rotation_engine** — v(r) — rotation velocity as a function of radius
  perspective=paradigm · engine=rotation · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **HB · efc.hubble_engine** — H(z) — the expansion rate
  perspective=paradigm · engine=hubble · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **GR · efc.growth_engine** — fσ8(z) — growth rate times amplitude
  perspective=paradigm · engine=growth · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **LN · efc.lensing_engine** — kappa(theta) — convergence as a function of angular position
  perspective=paradigm · engine=lensing · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **CL · efc.cluster_engine** — n(M,z) — the halo mass function
  perspective=paradigm · engine=cluster · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **MK · efc.mu_kz_engine** — mu(k,z) — the effective Poisson coupling
  perspective=paradigm · engine=mu_kz · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **RV · efc.romvaer_engine** — expected Kp, storm level, discharge trajectory
  perspective=paradigm · engine=romvaer · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **OR · efc.orbital_engine** — period, velocity, specific energy, Hill sphere
  perspective=paradigm · engine=orbital · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **KL · efc.klima_engine** — equilibrium temperature, time constant, regime switch
  perspective=paradigm · engine=klima · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **TI · efc.tidevann_engine** — tidal acceleration, tidal height, Roche limit, phase-lock status
  perspective=paradigm · engine=tidevann · bus=not specified · S-axis=not measured · questions=0 · group=yes
...
- **WA · efc.water_phase_engine** — phase boundaries P_sat(T), T_m(P), P_sub(T)
  perspective=paradigm · engine=water · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **PS · kjemi.periodesystemet** — the periodic table's structure (118 elements)
  perspective=academia · engine=not specified · bus=no bus route — the subject does not… · S-axis=not measured · questions=1 · group=yes

## Society
- **OK · efc.oekonomi_engine** — financial regime (hedge/speculative/ponzi), leverage drift
  perspective=paradigm · engine=oekonomi · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **SA · efc.samfunn_engine** — R0, outbreak status, the epidemic trajectory
  perspective=paradigm · engine=samfunn · bus=not specified · S-axis=not measured · questions=0 · group=yes
- **EF · efc.enerflyt_engine** — the buffer S and the drift dS/dt = P - C - L
  perspective=paradigm · engine=enerflyt · bus=not specified · S-axis=not measured · questions=0 · group=yes
...
- **L2 · efc.l2** — fsigma8, P(k), weak lensing (S8)
  perspective=paradigm · engine=not specified · bus=no bus route — the subject does not… · S-axis=regime S>0 · clarity C(S) at S>0: differentiated clarity… · questions=1 · group=none (regime)
