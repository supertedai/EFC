...
├── docs/
│   ├── papers/efc/     # 141 papers (140 with AI-friendly packages, 100%)
...
All 141 papers have full AI-friendly packages (10/10 standard: `src/`, `data/`, `examples/`, `CITATION.cff`, `LICENSE`, `citations.bib`, `schema.json`):
